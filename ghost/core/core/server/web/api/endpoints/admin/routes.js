...
module.exports = function apiRoutes() {
    ...
    router.get('/members/search', mw.authAdminApi, http(api.members.searchMembers));
    router.get('/members/:id/activity', mw.authAdminApi, http(api.members.getMemberActivity));
    router.get('/members/filter', mw.authAdminApi, http(api.members.findByFilter));
    ...
    router.post('/settings/import/xml', mw.authAdminApi, http(api.settings.importSettingsXml));
    router.get('/settings/system', mw.authAdminApi, http(api.settings.getSystemInfo));
